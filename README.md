...
- 当前已处理《李敖自传与回忆》《李敖自传与回忆续集》《我最难忘的事和人》《李敖回忆录》《李敖快意恩仇录》《李敖议坛哀思录》《李敖风流自传》《李敖相关》《传统下的独白》《传统下的再白》《独白下的传统》《李敖文存》《李敖文存二集》《波波颂》《李敖全集》《教育与脸谱》《文化论战丹火录》《为中国思想趋向求答案》《上下古今谈》《世论新语》《求是新语》《我是天安门》《你是景福门》的增量章节；其中《求是新语》与《我是天安门》都已阶段性收束，当前主线已切到《你是景福门》第一轮。《你是景福门》这一轮不只收文末署日，也补正文里李敖本人当事的事件：目前新收 `001 / 004 / 005 / 006 / 007 / 009 / 010 / 011 / 025 / 040` 十章，共 16 条，混合包括“李敖写《xxx》”的写作事件，以及演讲、发表、来访、拒见等本人动作；条目表述已统一压成短、实、贴原文的口径。此前《求是新语》第十轮 closeout 没有新增条目，维持 70 条，并把整本 `001-194` 的 keep-out 池重新收紧；《我是天安门》前三轮则已补齐 `001-040` 全目录并在第三轮 closeout 中把 `003 / 015 / 031` 按写作事件与宽日期口径正式入表，累计 40 条。其余各书仍按既有状态保留为参考与互校底盘，不在这里重述。
