...
data/timeline-events-sixth-book.json              105
总计                                             872
```
...
```text
事件总数：872
日期精度统计：day=660；year=43；undated-range=1；undated-context=99；season=17；lunar-day=1；year-after=6；month=19；half-year=2；day-range=9；month-after=2；year-range=4；year-about=5；day-after=3；year-end=1
```
...
1. 可继续处理 `101-120`，建议先扫日期锚点，再按李敖本人动作拆分。
2. 本轮暂缓的 `095.李杰下台了！.txt` 有记者会、送大奶嘴和给李杰信，但章节未给精确日期；后续可结合外部或后续章节校日后再入库。
3. 早前暂缓的 `063.最简明的智慧十题.txt`、`071.我的国民党观.txt`、`072.我的民进党观.txt`、`074.半坐半立式民主.txt` 偏无确日/评论总论；后续可在第六本模糊项轮次补，并放在对应年份精确日级事件之后。
4. `046.周公何辜啊！.txt`、`036.国家安全局对我下毒？.txt`、`031.我炮口转向了.txt` 仍是第六本模糊项轮次的重要候选。
...
1. 优先处理 `101-120`，继续按日期锚点和李敖本人动作拆分。
2. 回头集中处理 `031.我炮口转向了.txt`、`036.国家安全局对我下毒？.txt`、`046.周公何辜啊！.txt`、`063.最简明的智慧十题.txt`、`071.我的国民党观.txt`、`072.我的民进党观.txt`、`074.半坐半立式民主.txt`、`095.李杰下台了！.txt` 这类缺确日但能说明李敖策略/日常/评论动作的模糊项，确保放在对应年份精确日级事件之后。
