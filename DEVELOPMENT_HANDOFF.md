...
1. **短期建议：直接扫 `641-676`。**  
   这是第七本尾段，理论上比 `601-640` 更可能再出一些晚年节点。

2. **中期建议：做一次 Book 7 的“待校模糊项回收轮”。**  
   可优先回看：
   - `621.我的小女儿`
   - `638.“哈囉李敖”`
   - `640.罗所长的“神仙-老虎-狗”`
   - 以及前面已标暂缓但有味道的 `528 / 529 / 546 / 550`

3. **若 Book 7 到尾段新增持续偏少，可以切换成“双轨制”：**
   - 主轨：继续扫完第七本剩余章节
